<template>
    <VBottomNav :active.sync="bottomNav" shift app :value="bottomNavShow" class="hidden-lg-and-up">
      <VBtn color="red" :ripple="false" flat value="video" @click.stop="toVideo">
        <span>视频追踪</span>
        <VIcon>mdi-video-outline</VIcon>
      </VBtn>
      <VBtn color="indigo lighten-2" :ripple="false" flat value="up" @click.stop="toAuthor">
        <span>UP主追踪</span>
