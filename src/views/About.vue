  ...
  <div class="about">
    <div>
      ...
      <MaterialCard title="网站架构">
        ...
        <h4>前端</h4>
        <li>使用Vue.js</li>
        <li>应用了Vue全家桶，使用VueCli 3.0手脚架，集成Vuex前端状态管理、vue-router前端路由。</li>
        <li>应用了PWA（渐进式Web应用程序），能够在PC端和Web端获得原生应用般的体验，前提是使用Chrome、Safari、edge等主流浏览器。</li>
        ...
        <br>
        <h4>爬虫</h4>
        <li>爬虫使用Scrapy框架。这是一个基于Python的超强大爬虫框架，简单易于使用。</li>
        <br>
        <h4>数据库</h4>
        <li>
