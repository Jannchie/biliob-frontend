      ...
      timelinePost: [
        ...
        },
        {
          ...
          text: [
            ...
            "现在能够更加合理地统一手机端和PC端的UI风格。",
            "可能现在还比较简陋，我会不断添加新的功能和美化界面的。"
          ],
          type: "mix"
        },
        {
        ...
        },
        {
          ...
          date: "2018-11-22",
          text: [
            "使用Jenkins对后端进行持续集成。我终于良好地实现自动部署了。",
            "现在配置文件获得了更新，使用环境变量存储敏感信息。",
            "使用更为简洁的yaml配置文件，并且github上不再缺失配置文件了。"
          ],
          type: "structure"
        },
        {
          ...
          text: [
            "采用HTTPS传输数据，更加安全。",
            "其实我只是因为不安全网站无法显示小图标感到心塞塞才应用的HTTPS。",
        ...
        },
        {
          ...
          date: "2018-11-23",
          text: [
            "提高了兼容性，但是还不完美。现在应该能兼容大部分手机了，但是IE11会显示白屏。",
            "发现是vue-echarts模块的问题，但我尝试使用babel处理却无效，现已加入待办事项。"
          ],
          type: "fix"
        },
        {
        ...
        },
        {
          ...
          text: [
            ...
            "随手制作了一个看上去更精致的图标。",
            "最后使用了代码拆分的技术，试图减少首屏加载时间(好像效果极其不明显)。",
        ...
        {
          title: "修复错误 ver.0.3.3",
          date: "2019-01-12",
          text: ["修复了排行榜总是滞后一天的BUG", "美化了排行榜"],
          type: "fix"
        }
      ]
    };
