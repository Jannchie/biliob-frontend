<template>
  <VContainer>
        ...
        <VExpansionPanels tile>
          <VExpansionPanel>
            <VExpansionPanelHeader class="primary--text px-4"
              ><h3>
                <VIcon color="primary" left> mdi-account-group </VIcon>UP主群组
                / GROUP
            ...
            <VExpansionPanelContent class="px-0">
              ...
              <VRow dense>
                ...
                <VCol cols="auto" class="body-2">
                  ...
                  >
                  <VDialog v-model="createDialog" max-width="800px">
                    <VCard>
                      <VCardTitle>创建新群组</VCardTitle>
                      <VCardText>
                        <BiliobAuthorGroupInfoForm
                          @groupInfoSubmit="groupCreated"
                        ></BiliobAuthorGroupInfoForm>
                      </VCardText>
                    </VCard>
                  </VDialog>
    ...
    <VRow dense>
      ...
      <VCol class="align-self-center" cols="auto">
